...
class SiteInterfaceTest(unittest.TestCase):
    def test_independent_paper_route_is_data_driven_and_keeps_legacy_query_detail(self):
        ...
        self.assertIn("paper.publication_allowed === true && paper.publication_translation_url", paper_script)
        self.assertNotIn('paper.translation_status === "published"', paper_script)
        self.assertIn("paper.publication_allowed === true && paper.publication_translation_url", app_script)
