...
def classify_risk(metrics: dict[str, Any]) -> str:
    ...
    if (
        ...
        and metrics["images"] <= 2
        and metrics["drawings"] <= 500
        and metrics["numeric_citations"] <= 200
        and metrics["citation_ranges"] <= 20
        and metrics["reference_pages"] <= 3
        and metrics["contents_pages"] == 0
    ):
        return "citation_dense_passthrough_medium"
    ...
    return {
        ...
        "policy": {
            ...
            "risk_tiers": {
                ...
                "citation_dense_passthrough_medium": {"pages_max": 20, "images_max": 2, "drawings_max": 500, "numeric_citations_max": 200, "citation_ranges_max": 20, "reference_pages_max": 3, "contents_pages_max": 0, "figure_text": "source_verbatim", "references": "protected_and_self_checked"},
            },
        },
        ...
        "candidates_by_risk_tier": {
            ...
            for tier in ("low_risk", "text_only_medium", "figure_passthrough_medium", "text_only_long", "vector_passthrough_long", "citation_dense_passthrough_medium")
        },
        "records": rows,
    }
