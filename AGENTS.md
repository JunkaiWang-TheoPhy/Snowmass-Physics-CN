...
- An unchanged quarantined input must not re-enter a paid queue. Clearing quarantine requires a changed input fingerprint or explicit operator review. Paid production remains frozen until the zero-paid-call shadow gate passes; expansion beyond one paper remains frozen until the live DeepSeek probe passes.
